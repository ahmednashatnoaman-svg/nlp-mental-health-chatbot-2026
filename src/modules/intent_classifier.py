...
RULES:
- "asking_mental_health_question": any message about anxiety, depression, stress, panic attacks, therapy, mood, sleep issues, emotional distress, coping, mental wellbeing, or crisis.
- "out_of_scope": weather, sports, coding, math, anything unrelated to mental health.
